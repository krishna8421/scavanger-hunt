function privacy() {
  return (
    <div className="text-slate-200 w-full min-h-screen p-4">
      <h1>Privacy Policy for Scavenger Hunt</h1>

      <p>
        At Scavenger Hunt, accessible from https://scavenger-hunt.kiitians.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Scavenger Hunt and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in Scavenger Hunt.
      ...
      <p>
        {`        Scavenger Hunt follows a standard procedure of using log files. These files log visitors
      ...
      <p>
        {`        Like any other website, Scavenger Hunt uses 'cookies'. These cookies are used to store
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on Scavenger
        Hunt, which are sent directly to users' browser. They automatically receive your IP address
      ...
      <p>
        Note that Scavenger Hunt has no access to or control over these cookies that are used by
      ...
      <p>
        {`        Scavenger Hunt's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <p>
        Scavenger Hunt does not knowingly collect any Personal Identifiable Information from
